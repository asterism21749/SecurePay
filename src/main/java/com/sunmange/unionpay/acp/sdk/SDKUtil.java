 ...
 * =============================================================================
 */
package com.sunmange.unionpay.acp.sdk;
...
import static com.sunmange.unionpay.acp.sdk.SDKConstants.*;
...
public class SDKUtil {
     ...
     *
     * @param data     For the data to be signed, its key in Map format is equal to value.
     ...
     * @param data      For the data to be signed, its key in Map format is equal to value.
     * @param encoding  Encoding
     * @param secureKey Certificate absolute path
     * @param data      Certificate password
     ...
     * @param data     For the data to be signed, its key in Map format is equal to value.
     * @param encoding Encoding
     * @param certPath Certificate absolute path
     ...
     *
     * @param resData  Returned message data
...
//				LogUtil.writeLog("Conduct signature authentication for public key certificates:["+strCert+"]");
     ...
     *
     * @param data Map data to be merged
...
//			}
     ...
     * Decompress
     *
     * @param inputByte Data of byte[] array type
     ...
     * 压缩.
     *
     * @param inputByte Byte[] arrays to be decompressed
     ...
     *
     * @param s String data to be judged
