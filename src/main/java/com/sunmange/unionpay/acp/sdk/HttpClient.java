    ...
    private HttpURLConnection createConnection(String encoding) throws ProtocolException {
        ...
        if ("https".equalsIgnoreCase(url.getProtocol())) {
            ...
            if (!SDKConfig.getConfig().isIfValidateRemoteCert()) {
                ...
                husn.setHostnameVerifier(new BaseHttpSSLSocketFactory.TrustAnyHostnameVerifier());//Solve the problem that HTTPS cannot be accessed due to the server certificate.
            }
            return husn;
        }
