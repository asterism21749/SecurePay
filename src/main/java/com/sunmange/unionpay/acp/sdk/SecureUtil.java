...
public class SecureUtil {
     ...
     * SHA1 calculation
     *
     * @param datas Data to be calculated
     * @return Calculation result
     */
     ...
     *
     * @param datas    Data to be calculated
     * @param encoding Character set code
     * @return
     */
     ...
     *
     * @param dataString Data to be processed
     * @param encoding   Character code
     ...
     *
     * @param dataString Base64-encoded data
     * @param encoding   Encoding
     ...
     * BASE64 decoding
     *
     * @param inputByte Data to be decoded
     * @return Decoded data
     * @throws IOException
     */
     ...
     * BASE64 encoding
     *
     * @param inputByte Data to be encoded
     * @return Decoded data
     * @throws IOException
     */
